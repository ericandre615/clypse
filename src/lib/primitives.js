...
export const typeCheckers = {
  ...
  isArrayBuffer: obj => checkType(obj, primitives.arrayBuffer),
  isSharedArrayBuffer: obj => checkType(obj, primitives.sharedArrayBuffer),
  isDataView: obj => checkType(obj, primitives.dataView),
